...
{
    public partial class frmInfoGesGSOSCoordinadores : System.Web.UI.Page
    {
        Session session1;
		...
		/*CAMBIO						FECHA			AUTOR
		PARÁMETRO ROLE_ID				08-06-2021	    ALEXANDER FERNÁNDEZ 08-06-2021*/
		protected void SearchAllCoordinador()
        {

			//string role_id;
			//role_id = btnRole_id.Value.ToString();
        ...
        {			
			...
			if (e.NewValues["ROLE"] == null)
				...
				lcRole = (e.NewValues["ROLE"].ToString().Length == 0 ? "null" : e.NewValues["ROLE"].ToString());
			string Id = "";


            string[] parameters = { Id, lcDocCoordinador, lcNombreCoordinador.ToString().ToUpper(), lcRole };
        ...
        protected void UpdatedRowCoordinador(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
			...
			if (e.NewValues["ROLE"].ToString() != e.OldValues["ROLE"].ToString())
				if (e.NewValues["ROLE"] == null)
					lcRole = "";
				else
					lcRole = (e.NewValues["ROLE"].ToString().Length == 0 ? "null" : e.NewValues["ROLE"].ToString());
		...
		#region CboRole
		/*CAMBIO						FECHA			AUTOR
		SELECT COMBO ROLE				08-06-2021	    ALEXANDER FERNÁNDEZ 08-06-2021*/
		private void LoadCboRoles()
		{			
			DataSet ds2 = Code.Logic.Accounts.Role.GetRoleList();
			((GridViewDataComboBoxColumn)AspxGridGsoCoordinador.Columns["ROLE"]).PropertiesComboBox.DataSource = ds2.Tables[0];
			((GridViewDataComboBoxColumn)AspxGridGsoCoordinador.Columns["ROLE"]).PropertiesComboBox.TextField = ds2.Tables[0].Columns["DESCRIPTION"].Caption.ToString();
			((GridViewDataComboBoxColumn)AspxGridGsoCoordinador.Columns["ROLE"]).PropertiesComboBox.ValueField = ds2.Tables[0].Columns["ROLE_ID"].Caption.ToString();
			ds2.Dispose();
			ds2 = null;			
		}
		#endregion
		...
		protected void gvDetail_CustomCallbackG1(object sender, ASPxGridViewCustomCallbackEventArgs e)
		{
