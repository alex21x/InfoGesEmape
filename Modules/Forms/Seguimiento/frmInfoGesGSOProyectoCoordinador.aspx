<%@ Page Language="C#" MasterPageFile="~/Modules/MasterPage.Master" AutoEventWireup="true" 
    CodeBehind="frmInfoGesGSOProyectoCoordinador.aspx.cs" Inherits="InfogesEmape.Modules.Forms.Seguimiento.frmInfoGesGSOProyectoCoordinador" 
                                ...
                                <tr>
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="CUI" FieldName="ACT_PROY" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true"  CellStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" >
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <DataItemTemplate>
                                                <!--<a id="LinkButton1"  href="frmInfoGesGsoProyectoRegistroCoordinador.aspx?pOpera=edit&amp;pId=<%# Container.KeyValue%>"><%# Eval("ACT_PROY").ToString()%></a>-->
												<a href="frmInfoGesGSOPresupuesto.aspx?pOpera=edit&amp;pId=<%# Container.KeyValue%>"><%# Eval("ACT_PROY").ToString()%></a>
                                            </DataItemTemplate>
                                       </dx:GridViewDataTextColumn>
