...
{
    public partial class frmInfoGesGSOProyecto : System.Web.UI.Page
    {
        ...
        {
            XtraReport report = XtraReport.FromFile(Server.MapPath(@"~\Reports\Geso_rpt_AdvanceToDay.repx"), true);
        ...
        private void SearchAllProyecto(object sender)
        {
            ...
            ds3 = Code.Logic.Forms.Seguimiento.GsoProyecto.SearchAll("");
